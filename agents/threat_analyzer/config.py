"""
Threat Analyzer configuration — constants, thresholds, paths, and logging.
"""
...
# Suppress HuggingFace download / tokenizer / HTTP logs
...
logging.basicConfig(
    level=logging.INFO,
    format="%(asctime)s [THREAT_ANALYZER] %(levelname)s — %(message)s",
    datefmt="%H:%M:%S",
)
log = logging.getLogger("threat_analyzer")

# ── Paths ─────────────────────────────────────────────────────────────────────
BASE_DIR    = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
MODEL_DIR   = os.path.join(BASE_DIR, "models")
CONFIG_PATH = os.path.join(MODEL_DIR, "threat_config.json")
CLF_PATH    = os.path.join(MODEL_DIR, "threat_classifier.pkl")
LE_PATH     = os.path.join(MODEL_DIR, "threat_label_encoder.pkl")
