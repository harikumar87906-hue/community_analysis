"""
stia_agent.py — Backward-compatible re-export from agents.stia package.

The actual implementation is now modularized under agents/stia/:
...
from agents.stia import fetch_posts, analyze_post, print_results, ModelBundle

__all__ = ["fetch_posts", "analyze_post", "print_results", "ModelBundle"]


if __name__ == "__main__":
    from agents.stia.config import log
